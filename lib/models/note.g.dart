...
void _noteSerialize(
  ...
  writer.writeDateTime(offsets[0], object.lastEdit);
...
Note _noteDeserialize(
  ...
  final object = Note();
  object.id = id;
  object.lastEdit = reader.readDateTime(offsets[0]);
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastEdit',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> lastEditBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  QueryBuilder<Note, Note, QAfterSortBy> sortByLastEdit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastEdit', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByLastEditDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByLastEdit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastEdit', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByLastEditDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastEdit', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  QueryBuilder<Note, Note, QDistinct> distinctByLastEdit() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, DateTime, QQueryOperations> lastEditProperty() {
    return QueryBuilder.apply(this, (query) {
